...
searchButton.click(function(event) {
    ...
    $.getJSON({
        url: "http://api.giphy.com/v1/gifs/search?q="+ inputText + "&api_key=9z03PLu2MFfUFyoGbBD1qzIcdIAs3Qiz",
...
$.getJSON({
    url: "http://api.giphy.com/v1/gifs/trending?api_key=9z03PLu2MFfUFyoGbBD1qzIcdIAs3Qiz",
    success: function(res) {
        var gifsData =  res.data;
